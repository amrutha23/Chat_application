...
import com.example.chat_application.Fragments.Chats;
import com.example.chat_application.Fragments.Profile;
import com.example.chat_application.Fragments.Users;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot: dataSnapshot.getChildren()){
                    ...
                    if((chat.getReceiver().equals(firebaseUser) && !chat.isIsseen())){
                        unread++;
                    }
                }
                if(unread==0){
